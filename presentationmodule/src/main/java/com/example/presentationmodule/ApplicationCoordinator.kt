...
import com.example.presentationmodule.IApplicationCoordinatorViewModel
...
@Composable
fun ApplicationCoordinator(viewModel: IApplicationCoordinatorViewModel = hiltViewModel<ApplicationCoordinatorViewModel>()) {
